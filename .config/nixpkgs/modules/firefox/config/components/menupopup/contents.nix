  ...
  contents =
    ...
    ''
      ...
      .all-tabs-item[selected] {
      	border-left: 3px solid var(--nordic-tabbar-tab-active-border-bottom-color);
      ...
      #downloadsPanel-mainView .download-state:hover {
      	background-color: var(--nordic-popover-button-hover-background) !important;	
      }
      ...
      #confirmation-hint .panel-arrowcontent {
      	background: var(--nordic-button-suggested-action-background) !important;
      	border-color: var(--nordic-button-suggested-action-border-color) !important;
      }
      #confirmation-hint .panel-arrow {
      	fill: var(--nordic-button-suggested-action-border-color) !important;
      	stroke: var(--nordic-button-suggested-action-border-color) !important;
      }
      ...
      #protections-popup-tp-switch-section {
      	background: var(--nordic-menu-background);
      	border: 1px solid var(--nordic-button-border-color) !important;
      	border-radius: 9px;
      ...
      #protections-popup-tp-switch[enabled] {
      	background: var(--nordic-switch-active-background) !important;
      	border-color: var(--nordic-switch-active-border-color) !important;
      	border: 1px solid var(--nordic-button-border-color) !important;
      }
